(function () {
    ...
    function l() {
        if (document.body.scrollTop > t) u = false; else u = true
    }
    ...
    function p() {
        ...
        this.draw = function () {
            ...
            if (parseInt(Math.random()) * 100 % 3 == 0) i.fillStyle = "rgba(255,255,255," + n.alpha + ")"; else i.fillStyle = "rgba(237,194,123," + n.alpha + ")";
            i.fill()
        }
    }
